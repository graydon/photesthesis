...
public:
  int64_t getVar(std::string const &var) {
  ...
  void pushVar(std::string const &var, int64_t val) {
    mVarStack.emplace_back(var, val);
  }
  void popVar() { mVarStack.pop_back(); }
